...
class ExampleModel {
  ...
  @override
  String toString() {
    return 'ExampleModel(currentTemp: $currentTemp, currentSky: $currentSky, currentPressure: $currentPressure, currentWindSpeed: $currentWindSpeed, currentHumidity: $currentHumidity)';
  }
